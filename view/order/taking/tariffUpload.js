...
function set_upload_param(up, filename, ret) {
	...
	localStorage.setItem("tariff_photo",host + "/" + g_object_name);
...
var tariffUpload = new plupload.Uploader({
	runtimes: 'html5,flash,silverlight,html4',
	browse_button: 'previewTariff',
	//multi_selection: false,
	container: document.getElementById('tariffContainer'),
